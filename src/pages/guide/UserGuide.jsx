  ...
  return (
    <Container maxWidth="md" sx={{ marginTop: 4 }}>
      ...
      <Paper sx={{ padding: 4, marginTop: 4 }}>
        ...
        <Typography paragraph>
          The homepage displays various applications. Click on an app to either <b>Login</b> or view its guide.
        </Typography>
        ...
        <Typography paragraph>
          Use the search bar on the top right to quickly find an application.
        </Typography>
